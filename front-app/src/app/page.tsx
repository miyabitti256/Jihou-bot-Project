  ...
  return (
    <main className="container mx-auto px-4 py-8">
      <div className="flex flex-col items-center text-center space-y-6">
        <Image src="/images/clock-2.png" alt="時報Bot" width={150} height={150} className="mb-4" priority />
        ...
        <p className="text-xl mb-6">一日に一度、指定の時刻にメッセージを送信するBotです。</p>
        <p className="text-xl mb-6">テキストチャンネルやこのサイトでミニゲームも遊べるよ！</p>
